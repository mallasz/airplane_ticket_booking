...
# Global ticket manager object
ticket_manager = TicketManager()

# Utility function to get a valid integer input from user
...
# Utility function to get a valid float input from user
...
# Utility function to get a valid string input from user
...
# Displays and lets the user choose from existing airlines
def choose_airline() -> None | AirLine:
    ...
    if choice == 0:
        ...
        airline = list(airlines.values())[choice - 1]
        return airline

# Deletes a selected airline
def delete_airline():
...
# Lets the user choose a flight from a selected airline
...
# Changes the price of a selected flight
...
# Deletes a selected ticket reservation
def delete_ticket():
...
# File handling menu for saving, loading, and resetting system state
def handle_files():
    while True:
        print()
